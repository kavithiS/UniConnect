...
export const joinRequestAPI = {
  ...
  getGroupRequests: (groupId) =>
    api.get(`/requests/received?groupId=${groupId}`),
...
export const invitationAPI = {
  ...
  getStudentInvitations: (studentId) =>
    api.get(`/invitations/student/${studentId}`),
  getGroupInvitations: (groupId) => api.get(`/invitations/group/${groupId}`),
  accept: (invitationId) => api.put(`/invitations/${invitationId}/accept`),
  decline: (invitationId, data) =>
    api.put(`/invitations/${invitationId}/decline`, data),
