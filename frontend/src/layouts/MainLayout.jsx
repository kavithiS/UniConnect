        ...
        <div className="fixed inset-0 z-50 pointer-events-none flex items-center justify-center p-8">
          ...
          <button
            ...
            className={`absolute inset-0 pointer-events-auto transition-opacity duration-300 ${
              isChatOverlayVisible ? "opacity-100" : "opacity-0"
            } ${
          ...
          <dialog
            open
            className={`relative m-0 p-0 border-0 bg-transparent overflow-visible pointer-events-auto w-[min(100vw,1260px)] aspect-[2/1] h-auto max-h-[102vh] transition-all duration-700 ease-in-out ${
